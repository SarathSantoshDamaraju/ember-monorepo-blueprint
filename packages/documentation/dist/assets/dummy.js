...
;// delete this file
define("dummy/components/delete", [], function () {
  "use strict";
});
...
;define("dummy/sample-addon/tests/addon.lint-test", [], function () {
  "use strict";

  QUnit.module('ESLint | addon');
  QUnit.test('addon/components/delete/delete.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'addon/components/delete/delete.js should pass ESLint\n\n');
  });
});
;define("dummy/sample-addon/tests/app.lint-test", [], function () {
  "use strict";

  QUnit.module('ESLint | app');
  QUnit.test('app/components/delete.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'app/components/delete.js should pass ESLint\n\n');
  });
});
;define("dummy/sample-addon/tests/templates.template.lint-test", [], function () {
  "use strict";
});
